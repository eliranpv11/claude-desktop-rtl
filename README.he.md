...
- 🧱 **עמיד לעדכוני Claude.** השכבה מתייחסת ל*תגיות* הטקסט, לא לשמות ה-class של Claude — כך שעיצוב מחדש לא שובר אותה בשקט. ובווינדוס, כש-Claude מתעדכן, ה-watcher **מתקן את הגרסה החדשה מראש — עוד לפני שהיא נכנסת לתוקף** (MSIX מוריד אותה לדיסק שעות לפני), כך שהעברית חוזרת מעצמה ברגע שאתה מאשר את העדכון: בלי restart, בלי לחיצה, בלי אייקון, ובלי לסגור את Claude שרץ.
