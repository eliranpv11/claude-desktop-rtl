...
if (-not $IsAdmin) {
    ...
    $RepoUrl = "https://raw.githubusercontent.com/eliranpv11/claude-desktop-rtl/main/patch.ps1"
...
function Create-UpdateShortcut {
    ...
    Try {
        ...
        $Shortcut.Arguments = "-NoProfile -ExecutionPolicy Bypass -Command `"irm https://raw.githubusercontent.com/eliranpv11/claude-desktop-rtl/main/install.ps1 | iex`""
...
$installUrl     = "https://raw.githubusercontent.com/eliranpv11/claude-desktop-rtl/main/install.ps1"
